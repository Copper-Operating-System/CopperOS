...
; Increase this value if the kernel grows beyond KERNEL_SECTORS * 512 bytes.
...
start:
    ...
    ; Kernel starts at sector 2 (1-indexed) on the same disk.
    ; We read KERNEL_SECTORS sectors to accommodate future kernel growth.
    ...
    mov bx, 0x8000      ; Load kernel at memory address 0x8000
    int 0x13
